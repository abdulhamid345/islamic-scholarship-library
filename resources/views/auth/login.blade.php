        ...
        <div class="w-full max-w-2xl mx-auto px-6 relative z-10">
            ...
            <div class="glass-morphism rounded-2xl p-8 shadow-2xl" data-aos="fade-up">
                ...
                <div class="flex mb-8 border-b border-gray-200">
                    <button id="loginTab" class="tab-button active flex-1 py-3 text-center font-semibold text-gray-600">
                        Sign In
                    </button>
                    <button id="registerTab" class="tab-button flex-1 py-3 text-center font-semibold text-gray-600">
                        Sign Up
                    </button>
                </div>
