            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="flex justify-between h-16">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-nav-link :href="route('dashboard.books.index')" :active="request()->routeIs('books.*')" class="text-white hover:text-green-300">
                            {{ __('Books') }}
                        </x-nav-link>
                        <x-nav-link :href="route('dashboard.category.index')" :active="request()->routeIs('category.*')" class="text-white hover:text-green-300">
                            {{ __('Categories') }}
                        </x-nav-link>
                        <x-nav-link :href="route('dashboard.scholars.index')" :active="request()->routeIs('scholars.*')" class="text-white hover:text-green-300">
                            {{ __('Scholars') }}
                        </x-nav-link>
                    </div>
